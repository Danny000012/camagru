...
function send_email($mail, $login, $mdp)
{
	...
	$message_html = "<html><head></head><body><b>Bonjour</b><br/>Vous venez de vous inscrire sur le site web Camagru ! <br/>Pour valider votre compte cliquez sur le lien suivant: <br/> <a href='http://localhost:8888/camagru/script/confirm_account.php?login=".$login."&key=".$mdp."'></a></body></html>";
	$boundary = "-----=".md5(rand());
